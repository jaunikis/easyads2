...
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v2.11&appId=501513060220599';
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#about">Pradžia</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Paslaugos</h2>
            <hr class="my-4">
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <h3 class="mb-3">Transportas</h3>
              <p class="text-muted mb-0">Siuntinių, krovinių ir gyvūnų pervežimas reisu<br>Lietuva-Anglija-Airija.</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class="fa fa-4x fa-paper-plane text-primary mb-3 sr-icons"></i>
              <h3 class="mb-3">Mūsų tikslas</h3>
              <p class="text-muted mb-0">Laiku ir saugiai pristatyti krovinius bei siuntas į paskirties vietą.</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              <i class="fa fa-4x fa-address-card text-primary mb-3 sr-icons"></i>
              <h3 class="mb-3">Jūsų patogumui</h3>
              <p class="text-muted mb-0">Siuntiniai ir kroviniai paimami iš namų ir pristatomi pagal nurodytą adresą.</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
