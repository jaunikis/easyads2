					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="panel blog-article-box top-space">
							<div class="panel-heading">
								<h1 style="color:#515355;font-weight:bold;margin-bottom:0;font-size:32px;">Online Safety Tips</h1>
								<small>It is important to learn how to stay safe online.</small>
							...
							<div class="panel-image">
								<img class="img-responsive img-thumbnail center-block" src="/images/blog/safety.jpg" alt="Online safety">
							</div>
							...
							<h3 id="Introduction">Introduction</h3>
								<p>The benefit of the Web have come at some cost, one being the loss of privacy. 
								if you use the internet, you could be at risk of illegal activity or abuse – be it bullying,
								fraud or something more serious. Unlike seeing someone face to face, on the net,
								people aren’t always what they first seem.
								It is important to learn how to stay safe online. These skills will stay with you for life and even can save lots of money!
								</p>
								<p>We filter and don't display danger or potential scam adverts. But we can't detect 100% of them. 
								So you have to be aware and examine carefully an advert before take action on it.
								</p>
								<hr>
								...
								<h3 id="How to identify that advert is fraud">How to identify that advert is fraud?</h3>
								<br>
								...
								<div class="row">
									...
									Don't pay any deposit for item online! 
									Unless you met seller in person and get receipt or signed note that he received deposit from you. 
									And even that is not keeping seller to get away with your money. 
									So avoid any deposit paying in front. 
									</p>
								</div>
								<br>
