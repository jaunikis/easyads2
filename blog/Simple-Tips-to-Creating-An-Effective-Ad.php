				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="panel blog-article-box top-space">
							...
							<h4>
							<ol>
								<li><a href="#What Makes You Stand Out">What Makes You Stand Out</a></li>
								<li><a href="#Use A Powerful Headline">Use A Powerful Headline</a></li>
								<li><a href="#Make Them An Offer">Make Them An Offer</a></li>
							...
							<hr>
							<h3 id="What Makes You Stand Out">What Makes You Stand Out From Your Competition?</h3>
								<p>
								...
								<ol>
								<li>Each advertisement must make a proposition to the consumer-not just words, product puffery, or show-window advertising. Each advertisement must say to each reader: “Buy this product, for this specific benefit.”
								</li>
								<li>
							...
							<h3 id="Use A Powerful Headline">Use A Powerful Headline: Grab Their Attention!</h3>
								<p>
								...
								<p>
								All that came from an effective headline.I have written sales letters that have gotten tremendous response mainly due to powerful headlines.
								</p>
								<p>
								...
								<p>
								Jay Abraham, an online marketer and consultant, compiled a list of the <a target="blank" href="http://www.mastercopywriters.com/greatestheadlines.htm">100 best headlines ever written.</a>
								</p>
							<h3 id="Make Them An Offer">Make Them An Offer They Can’t Refuse!</h3>
								<p>
								...
								<p>
								This is a very powerful concept and can make or break your business. To understand more, take a few minutes and <a target="blank" href="http://youtu.be/Bw62m8XC0hE">watch this video</a> by Jay Abraham.
								</p>
							<h3 id="Talk About The Benefits">Talk About The Benefits – What’s In It For Them!</h3>
								<p>
								...
								<ol>
								<li>List out all your services (or products).</li>
								<li>For each one, list out everything that service (feature) does.</li>
								<li>Then, next list out what the result of each feature is – the benefit for the client.</li>
								</ol>
								<p>
							...
							<h3 id="Tell Your News">Tell Your News: Create an Advertorial!</h3>
								<p>
							...
							<h3 id="Take Away Their Fear">Take Away Their Fear: Make Your Offer As Risk-Free As Possible!</h3>
								<p>
							...
							<h3 id="Call To Action">The “Call To Action” And Asking Them To Buy – Or Not!</h3>
								<p>
							...
							<h3 id="Make It Seem Urgent">Make It Seem Urgent, Give Them A Reason To Buy NOW!</h3>
								<p>
							...
							<h3 id="Use Testimonials">Use Testimonials</h3>
								<p>
							...
							<h3 id="Use Exciting Graphics and Images">Use Exciting Graphics and Images</h3>
								<p>
								People are visual.
								</p>
								<p>
							...
							<h3 id="Complete Contact Information">Complete Contact Information</h3>
								<p>
							...
							<h3 id="Always DELIVER">Always Deliver</h3>
								<p>
							...
							<h3>Making Yourself Stand Out</h3>
								<p>
								...
								<p>
								<b>Advertising is important and good advertising is what will help your company succeed.</b>
								</p>
